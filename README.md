...
> Crafting solutions to solve real problems for [@swanagata](https://github.com/swanagata)

I'm an indie maker and full-stack developer based in **Jakarta, Indonesia** 🇮🇩 — building SaaS products, open-source packages, and native apps for macOS & iOS.

---

## 🛠 What I Build

- **Web apps** — Laravel, React, Next.js, multi-tenant SaaS
- **Mobile apps** — Swift/SwiftUI (iOS & macOS), Flutter
- **Open-source packages** — PHP/Laravel libraries
- **Indie products** — Pomodoro timers, screenshot tools, image converters, fitness integrations
...
- 🌐 [abduns.com](https://abduns.com)
- 📍 Jakarta, Indonesia

---

*Building in public. Open to collaboration and sponsorship.*
